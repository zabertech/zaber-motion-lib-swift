...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://software.zaber.com/downloads/ZML/Swift/8.1.0/ZaberMotionCore.xcframework.zip",
        checksum: "d79e72fd897dbe79d196a69ffbf7ac94257f19275fd29fc298394790357446c9"
        ),
        .target(
            name: "ZaberMotion",
            dependencies: [
