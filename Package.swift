...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://software.zaber.com/downloads/ZML/Swift/8.0.1/ZaberMotionCore.xcframework.zip",
        checksum: "944377faa6a9a733151da133f435d0944e991dd5d2d693e5939cddf067b9984e"
        ),
        .target(
            name: "ZaberMotion",
            dependencies: [
