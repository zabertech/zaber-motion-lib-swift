 ...
 */
public enum PvtPartialSequenceItem: Serializable {
    /**
     * Holds the value when the variant contains type PvtPartialPoint.
     */
    case pvtPartialPoint(PvtPartialPoint)
    ...
    public init(from decoder: Decoder) throws {
        ...
        switch tag {
        case "PvtPartialPoint":
            let value = try container.decode(PvtPartialPoint.self, forKey: CodingKeys.pvtPartialPointValue)
            self = .pvtPartialPoint(value)
        case "PvtCallAction":
        ...
        default:
            throw SerializationError.deserializationFailed(object: "PvtPartialSequenceItem",
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .pvtPartialPoint(let value):
            try container.encode("PvtPartialPoint", forKey: CodingKeys.variantValueType)
            try container.encode(value, forKey: CodingKeys.pvtPartialPointValue)
