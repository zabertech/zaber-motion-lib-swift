...
public struct Response: Serializable {
    ...
    public static func fromByteArray(_ byteArray: Data) throws -> Response {
        do {
            let bson = try BSONDocument(fromBSON: byteArray)
            return try BSONDecoder().decode(Response.self, from: bson)
        } catch {
            throw SerializationError.deserializationFailed(object: "Response", error: error)
        }
    }
    ...
    public func toByteArray() throws -> Data {
        do {
            ...
            throw SerializationError.serializationFailed(object: "Response", error: error)
        }
    }
}
